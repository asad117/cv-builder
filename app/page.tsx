      ...
      <aside className={`w-full lg:w-[450px] bg-white border-r border-slate-200 flex flex-col shadow-xl z-10 
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
          {/* <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center font-bold text-white">CV</div>
            <h1 className="font-bold text-xl text-slate-800">CV.AI</h1>
          </div> */}
          <div className="flex items-center gap-2">
